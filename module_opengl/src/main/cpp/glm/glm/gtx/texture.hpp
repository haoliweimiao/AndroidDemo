...
/// @ingroup gtx
///
/// Include <glm/gtx/textureId.hpp> to use the features of this extension.
///
/// Wrapping mode of textureId coordinates.
...
namespace glm
{
	...
	/// Compute the number of mipmaps levels necessary to create a mipmap complete textureId
	///
	/// @param Extent Extent of the textureId base level mipmap
