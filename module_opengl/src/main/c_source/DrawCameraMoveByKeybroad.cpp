...
int Init(ESContext *esContext) {
    ...
    userData->texture1 = loadTextureByMgr((AAssetManager *) esContext->assetManager,
                                          "image/awesomeface.png");
    userData->texture2 = loadTextureByMgr((AAssetManager *) esContext->assetManager,
...
void KeyEvent(ESContext *esContext, unsigned char key, int i1, int i2) {
    esLogMessage("Receiver keyboard from android:%d", key);
